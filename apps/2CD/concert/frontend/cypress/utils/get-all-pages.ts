...
const root = './apps/2CD/concert/frontend/src/app';
...
export const getAllPages = () => {
  ...
  fs.writeFileSync(path.join(...'apps/2CD/concert/frontend'.split('/'), 'cypress', 'utils', 'all-pages.json'), JSON.stringify(pages));
