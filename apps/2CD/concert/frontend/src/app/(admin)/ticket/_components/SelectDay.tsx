      ...
      <Popover data-testid="popover">
        <PopoverTrigger data-testid="popover-trigger" asChild>
          <FormControl data-testid="form-control">
            <Button data-testid="open-calendar-btn" data-cy={hideLabel ? 'open-calendar-filter' : 'open-calendar-form'} variant={'outline'} className="w-[200px] pl-3 text-left font-normal">
